  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-stretch">
      ...
      <div className="hidden md:flex md:w-1/2 relative overflow-hidden flex-col justify-between p-12"
        ...
        {/* Brand */}
        <Link to="/" className="font-serif text-2xl font-bold text-white tracking-tight relative z-10">
          AyurSutra
        </Link>
      ...
      <div className="flex-1 flex items-center justify-center p-6 md:p-12 bg-[#fafaf8]">
        <div className="w-full max-w-md">
          {/* Mobile brand */}
          <Link to="/" className="md:hidden font-serif text-xl font-bold text-amber-800 tracking-tight block mb-8">
            AyurSutra
          </Link>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="mt-1.5 text-right">
                <a href="#" className="text-xs text-amber-700 hover:text-amber-900 font-medium transition-colors">
                  Forgot password?
                </a>
              </div>
            </div>
