...
const services = [
  {
    ...
    desc: 'Full Ayurvedic intake with Prakriti, Agni, Koshta, Nadi Pariksha — Structured Input Method for 100% data uniformity.',
    link: '/register',
  ...
  {
    icon: '⚕️',
    title: 'Therapy Scheduler',
    desc: 'AI-powered therapy recommendations with live contraindication alerts based on Agni, Koshta & Prakriti.',
    link: '/schedule',
  ...
  {
    icon: '🗓️',
    title: 'Multi-Day Cycle Planner',
    desc: 'Full Purvakarma → Pradhanakarma → Paschatkarma cycle with inventory tracking and therapist allocation.',
    link: '/cycle',
    cta: 'Plan Therapy Cycle',
    accentColor: 'forest' as const,
  },
  {
    icon: '🥗',
    title: 'AI Diet Planner',
    desc: 'Agni-aware personalized meal suggestions with Samsarjana Krama guidance aligned to dosha type.',
    link: '/diet',
    cta: 'Try Diet Demo',
    accentColor: 'forest' as const,
  },
  {
    ...
    desc: 'Searchable EHR with Ayurvedic parameters — filter by Agni, Koshta, Prakriti with safety alerts.',
    link: '/records',
    cta: 'View Records',
  ...
  },
  {
    ...
    desc: 'Feature importance heatmaps and confusion matrices for Dosha, Therapy, and Diet models.',
    link: '/heatmap',
    cta: 'View Heatmap',
    accentColor: 'blue' as const,
  },
